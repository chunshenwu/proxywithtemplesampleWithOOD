 ...
 */
public class ChargeMasterItem1 extends BaseDetectItemsProxyPresenter {
    ...
    public ChargeMasterItem1(final Context context){
        super(context);
    }
    ...
    public int getHeaderTitleResId() {
        return R.string.lk_detect_item_charge_master_title1;
    }

    @Override
    public int getBodyViewResourceId() {
        return R.layout.lk_detect_item_charge_master_body1;
    }
