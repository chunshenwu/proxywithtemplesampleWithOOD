 ...
 */
public class ChargeMasterItem3 extends BaseDetectItemsProxyPresenter {
    ...
    public ChargeMasterItem3(final Context context){
        super(context);
    }
    ...
    public int getHeaderTitleResId() {
        return R.string.lk_detect_item_charge_master_title3;
    }

    @Override
    public int getBodyViewResourceId() {
        return R.layout.lk_detect_item_charge_master_body3;
    }
