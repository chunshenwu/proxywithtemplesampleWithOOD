 ...
 */
public class ChargeMasterItem6 extends BaseDetectItemsProxyPresenter {
    ...
    public ChargeMasterItem6(final Context context){
        super(context);
    }
    ...
    public int getHeaderTitleResId() {
        return R.string.lk_detect_item_charge_master_title6;
    }

    @Override
    public int getBodyViewResourceId() {
        return R.layout.lk_detect_item_charge_master_body6;
    }
