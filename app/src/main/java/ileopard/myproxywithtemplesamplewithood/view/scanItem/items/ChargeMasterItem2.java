 ...
 */
public class ChargeMasterItem2 extends BaseDetectItemsProxyPresenter {
    ...
    public ChargeMasterItem2(final Context context){
        super(context);
    }
    ...
    public int getHeaderTitleResId() {
        return R.string.lk_detect_item_charge_master_title2;
    }

    @Override
    public int getBodyViewResourceId() {
        return R.layout.lk_detect_item_charge_master_body2;
    }
