 ...
 */
public class ChargeMasterItem extends BaseDetectItemsProxyPresenter {
    ...
    public ChargeMasterItem(final Context context){
        super(context);
    }
    ...
    public int getHeaderTitleResId() {
        return R.string.lk_detect_item_charge_master_title;
    }

    @Override
    public int getBodyViewResourceId() {
        return R.layout.lk_detect_item_charge_master_body;
    }
