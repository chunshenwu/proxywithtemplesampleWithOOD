 ...
 */
public class ChargeMasterItem5 extends BaseDetectItemsProxyPresenter {
    ...
    public ChargeMasterItem5(final Context context){
        super(context);
    }
    ...
    public int getHeaderTitleResId() {
        return R.string.lk_detect_item_charge_master_title5;
    }

    @Override
    public int getBodyViewResourceId() {
        return R.layout.lk_detect_item_charge_master_body5;
    }
